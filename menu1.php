        ...
        echo '<font size="4 px"><a href="?q=cmd#cmd">'.$_SESSION['cpt'].'</a></font>' ;
            ...
            echo '0';
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="admin/pages/inscription.php"><i class="fa fa-sign-out fa-fw"></i>Inscription</a>
                        </li>
                        <li class="divider"></li>
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  <li class="active"><a href="index.php#intro">
                                                                  	<span class="glyphicon glyphicon-home"></span>
                                                                  </a></li>
                                                                  <li><a class="fa fa-male" href="index.php#hommes">Hommes</a></li>
                                                                  <li><a class="fa fa-female" href="index.php#femmes">Femmes</a></li>
