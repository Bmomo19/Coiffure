...
<head>
    ...
    <title> <?php echo $_SESSION['nom'].'  '.$_SESSION['prenoms'];?>/Liste des fournisseurs</title>
    <?php 
                            ...
                            <div class="table-responsive">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$req2 = $db->prepare('SELECT COUNT(*) AS nombre FROM 
									  ...
									  echo 'Nombre de fournisseur:'.$nombre.'<br>';
										}
									...
									// liste des client  client
									       $couleur[]='success';
											...
											$couleur[]='warning';
											$couleur[]='danger';
										    $req1 = $db->prepare('SELECT *  FROM fournisseur');
									...
									?>
                                        <tr class="<?php echo $couleur[$cpt]; ?>">
                                            ...
                                            <td><?php echo $resultat['nomfseur'].' '.$resultat['prenfseur']; ?></td>
                                            <td><?php echo $resultat['telfseur']; ?></td>
                                            <td><?php echo $resultat['mailfseur']; ?></td>
                                        </tr>
