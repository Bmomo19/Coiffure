   ...
   ?>
     ...
     <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Liste des rdv</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nom et Prenoms Personnel</th>
									...
									?>
                                        <tr class="<?php echo $couleur[$cpt]; ?>">
                                            ...
                                            <td><?php echo $resultat['daterdv']; ?></td>
                                            <td><?php echo $resultat['objetrdv']; ?></td>
                                            <td><?php echo $resultat['nomclt'].' '.$resultat['prenclt']; ?></td>
                                            <td><?php echo $resultat['nompers'].' '.$resultat['prenpers']; ?></td>
                                            <td><?php echo $resultat['nomprest']; ?><br>
                                                <em>(<?php echo $resultat['tarifprest'].' Fr'; ?>) </em>
                                            </td>
                                            <td><?php echo $resultat['nommod']; ?><br>
                                                <em>(<?php echo $resultat['tarifmod'].' Fr'; ?>) </em>
