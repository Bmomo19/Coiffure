        ...
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
         ...
         <div>    
              ...
              <li class="dropdown">
			   ...
			   <?php if(isset($_SESSION['cnx']) and $_SESSION['cnx']=='Deconnexion'){ echo '<a href="save/deconnection.php">'.$_SESSION['cnx'].'</a>';} 
           else {echo ' <a href="login.php">Connexion </a>';}?>
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="pages/inscription-client.php"><i class="fa fa-sign-out fa-fw"></i>Inscription</a>
                        </li>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
					    <?php 
						if(isset($_GET['q'])&& $_GET['q']=="clt"){
						echo'<div class="alert alert-dismissable alert-danger">
							<button type="button" class="close" data-dismiss="alert">×</button>
							Connectez- vous dabord avant toutes operations!
							 </div>';
							 }
							 ?>
                       <form role="form" action="save/cnx-clt.php" method="post">
                            <fieldset>
							 ...
							 <a href="pages/inscription-client.php">S'inscrire</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
